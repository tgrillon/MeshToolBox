...
constexpr bool EqualNear(BaseType::Vec2 lhs, BaseType::Vec2 rhs, float eps = 1e-6) constexpr bool EqualNear(
	BaseType::Vec2 lhs, BaseType::Vec2 rhs, float eps = 1e-6)
{
	return EqualNear(lhs.x, rhs.x, eps) && EqualNear(lhs.y, rhs.y, eps);
}

/// @brief Helper function to compare two Vec3 variables.
constexpr bool EqualNear(BaseType::Vec3 lhs, BaseType::Vec3 rhs, float eps = 1e-6) constexpr bool EqualNear(
	BaseType::Vec3 lhs, BaseType::Vec3 rhs, float eps = 1e-6)
{
